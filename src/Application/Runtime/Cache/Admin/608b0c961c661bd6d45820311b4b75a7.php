    ...
    <div class="formbody">
        ...
        <form action="<?php echo U('edit');?>" method="post" enctype="multipart/form-data">
            <ul class="forminfo">
                <li>
                    <label>商品名称</label>
                    <input name="goods_name" placeholder="请输入商品名称" type="text" class="dfinput" value="<?php echo ($data["goods_name"]); ?>" /><i>名称不能超过30个字符</i></li>
                <li>
                    <label>商品价格</label>
                    <input name="goods_price" placeholder="请输入商品价格" type="text" class="dfinput" value="<?php echo ($data["goods_price"]); ?>" /><i></i></li>
                <li>
                    <label>商品数量</label>
                    <input name="goods_number" placeholder="请输入商品数量" type="text" class="dfinput" value="<?php echo ($data["goods_number"]); ?>" />
                    <input type="hidden" name="goods_id" value="<?php echo ($data["goods_id"]); ?>">
                </li>
                <li>
                    <label>商品重量</label>
                    <input name="goods_weight" placeholder="请输入商品重量" type="text" class="dfinput" value="<?php echo ($data["goods_weight"]); ?>" />
                </li>
                <li>
                    <label>商品图片</label>
                ...
                -->
                <li>
                    <label>商品描述 <textarea id="ue" name="goods_introduce" placeholder="请输入商品描述" cols="" rows="" style="width:600px;height:400px;"><?php echo ($data["goods_introduce"]); ?></textarea></label>
